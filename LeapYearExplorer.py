...
# that prompts the user to input a year. The program should 
# determine if the given year is a leap year or not and then 
# display an appropriate message. Please note that this is the 
# definition of a leap year: Every year that is exactly divisible by four is a leap year, 
